...
function Homepage() {
  ...
  const [currentStep, setCurrentStep] = useState('support');
          ...
          {currentStep === 'support' && (
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button onClick={() => handleSupportTypeSelect('gentle')} className="p-6 rounded-xl bg-gray-700/50 hover:bg-gray-700 transition-all hover:scale-105 flex flex-col items-center gap-3">
                  <Heart className="text-green-400 w-8 h-8" />
                  <span className="font-medium text-white">🌿 Gentle Listener</span>
                </button>
                <button onClick={() => handleSupportTypeSelect('motivational')} className="p-6 rounded-xl bg-gray-700/50 hover:bg-gray-700 transition-all hover:scale-105 flex flex-col items-center gap-3">
                  <Sparkles className="text-orange-400 w-8 h-8" />
                  <span className="font-medium text-white">💪 Motivational Boost</span>
                </button>
                <button onClick={() => handleSupportTypeSelect('mindful')} className="p-6 rounded-xl bg-gray-700/50 hover:bg-gray-700 transition-all hover:scale-105 flex flex-col items-center gap-3">
                  <Brain className="text-blue-400 w-8 h-8" />
                  <span className="font-medium text-white">🧘 Calm + Mindfulness</span>
                </button>
                <button onClick={() => handleSupportTypeSelect('reflective')} className="p-6 rounded-xl bg-gray-700/50 hover:bg-gray-700 transition-all hover:scale-105 flex flex-col items-center gap-3">
