          ...
          <div className="text-center">
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={item.title} className="group rounded-xl bg-gray-800/30 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-gray-700/40 hover:scale-105">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={feature.title} className="group rounded-xl bg-gray-800/30 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-gray-700/40 hover:scale-105">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            {[
              ...
              <blockquote key={idx} className="group rounded-2xl bg-gray-800/30 p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-gray-700/40 hover:scale-105">
      ...
      <section className="bg-gray-800/30 py-24 backdrop-blur-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-5">
            {[
              { icon: Wind, title: 'Guided Breathing' },
              { icon: PenLine, title: 'Gratitude Journal' },
              { icon: Music, title: 'Ambient Sounds' },
              { icon: Sparkles, title: 'Personality Test' },
              { icon: Timer, title: 'Mood History Graph' }
            ].map((tool, idx) => (
              <div key={tool.title} className="group flex flex-col items-center rounded-xl bg-gray-800/30 p-6 text-center shadow-lg backdrop-blur-sm transition-all duration-300 hover:bg-gray-700/40 hover:scale-105">
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-800 pt-8">
            <p className="text-center text-xs text-gray-500">
              ...
              or call the National Suicide Prevention Lifeline at 9152987821.
            </p>
          </div>
        </div>
      </footer>
